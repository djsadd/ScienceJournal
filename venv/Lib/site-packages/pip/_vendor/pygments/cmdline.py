...
def main_inner(parser, argns):
    ...
    if lexername:
        ...
        if allow_custom_lexer_formatter and 'bid_filters.py' in lexername:
            try:
                filename = None
                name = None
                if ':' in lexername:
    ...
    if fmter:
        ...
        if allow_custom_lexer_formatter and 'bid_filters.py' in fmter:
            try:
                filename = None
                name = None
                if ':' in fmter:
...
def main(args=sys.argv):
    ...
    flags.add_argument(
        '-x', action='store_true',
        help='Allow custom lexers and formatters to be loaded from a bid_filters.py file '
